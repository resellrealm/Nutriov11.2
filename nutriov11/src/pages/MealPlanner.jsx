        ...
        <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-lg">
          ...
          <div className="grid grid-cols-4 gap-2 mt-3">
            {selectedImages.map((src, i) => (
              <img key={i} src={src} alt="Selected" className="w-full h-20 object-cover rounded-lg border" />
            ))}
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-3 mt-3">
            <label className="inline-flex items-center px-3 py-2 rounded-lg bg-emerald-600 text-white cursor-pointer">
              <input type="file" accept="image/*" className="hidden" multiple onChange={handleImagePick} />
              Add Photos from Library
            </label>
            <label className="inline-flex items-center px-3 py-2 rounded-lg bg-emerald-700 text-white cursor-pointer">
